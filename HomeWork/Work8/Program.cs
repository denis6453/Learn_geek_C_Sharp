...
////////////////////////////////////////////////////////////////////////сначала пытался полностью рекурсией (работало но с какого то момента начиналось заполнять змейкой), поэтому решил переделать и идти по границам каждый раз сужая квадрат
...
//////////////////////////////////////////////////////////////////////////////ПОПЫТКА 2 (идти по границам сужая квадрат) получается только для квадратных матриц решение
